...
def compile_deep_q_network():
    ...
    model = Sequential([
        Dense(DENSE_LAYER_DIMS, input_shape=(STATE_SHAPE,), initializer=he, activation=ACTIVATION_FUNCTION),
        Dense(DENSE_LAYER_DIMS, initializer=he, activation=ACTIVATION_FUNCTION),
        Dense(NUMBER_OF_ACTIONS, initializer=he, activation=softmax),
    ])
